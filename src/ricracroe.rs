...
impl RRRBoard {
    pub fn get_xsize(&self) -> u32 {
        self.xsize
    }

    pub fn get_ysize(&self) -> u32 {
        self.ysize
    }

    pub fn fetch(&self, x: u32, y: u32) -> Result<RRRCell, &'static str> {
    ...
    pub fn set(&mut self, x: u32, y: u32, new_state: RRRCell) -> Result<RRRCell, &'static str> {
    ...
    pub fn make_move(&mut self, x: u32, y: u32, new_state: RRRCell) -> Result<RRRCell, &'static str> {
    ...
    pub fn new_anysize(xsize: u32, ysize: u32) -> Self {
...
#[allow(dead_code)]
fn main() {
    let mut board = RRRBoard::new_anysize(8,6);
